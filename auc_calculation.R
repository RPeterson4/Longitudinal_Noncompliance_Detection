...
mk1 = matrix(c(c_mat[,t],pk1),ncol=2)
dk1 = mk1[order(mk1[,2]),]
pk1d = colMeans(matrix(dk1[,2],ncol=10))
ck1d = colSums(matrix(dk1[,1],ncol=10))/(n/10)

## Plot the calibration line with 45 degree line
plot(1,type="n",xlab="",ylab="",ylim=c(0,1),xlim=c(0,1))
abline(0,1,col="red",lwd=3)
lines(pk1d,ck1d,lwd=3)